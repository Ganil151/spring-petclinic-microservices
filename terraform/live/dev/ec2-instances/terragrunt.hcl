...
inputs = {
  ...
  # Render User data
  bastion_user_data = base64gzip(templatefile("${get_terragrunt_dir()}/../../../modules/scripts/bastion_bootstrap.sh.tftpl", {
  ...
  jenkins_user_data = base64gzip(templatefile("${get_terragrunt_dir()}/../../../modules/scripts/jenkins_bootstrap.sh.tftpl", {
  ...
  worker_user_data = base64gzip(templatefile("${get_terragrunt_dir()}/../../../modules/scripts/worker_bootstrap.sh.tftpl", {
  ...
  sonarqube_user_data = base64gzip(templatefile("${get_terragrunt_dir()}/../../../modules/scripts/sonarqube_bootstrap.sh.tftpl", {
